...
csv_json_converter('./datasets/location.csv', '../ads/fixtures/location.json', 'authentication.location')
csv_json_converter('./datasets/user.csv', '../ads/fixtures/user.json', 'authentication.user')
